<?php
/**
 * Custom widget for displaying facebook link
 *
 ...
 */
class Benefactor_Facebook_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Facebook Link Widget', // Name
			array( 'description' => __( 'The Facebook Link Widget', 'benefactor' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		extract( $args );
		$url = ( get_field( 'bene_facebook_link', 'option' ) ? get_field( 'bene_facebook_link', 'option' ) : '' );
...
function facebook_widget() {
	register_widget( 'Benefactor_Facebook_Widget' );
}
?>