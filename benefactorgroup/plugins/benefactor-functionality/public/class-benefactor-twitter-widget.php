<?php
/**
 * Custom widget for displaying Twitter link
 *
 ...
 */
class Benefactor_Twitter_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Twitter Link Widget', // Name
			array( 'description' => __( 'The Twitter Link Widget', 'benefactor' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		extract( $args );
		$url = ( get_field( 'bene_twitter_link', 'option' ) ? get_field( 'bene_twitter_link', 'option' ) : '' );
...
function twitter_widget() {
	register_widget( 'Benefactor_Twitter_Widget' );
}
?>