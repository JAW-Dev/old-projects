<?php
/**
 * Custom widget for displaying the client categories
 *
 ...
 */
class Benefactor_Client_Cat_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		'client_cat', // Base ID
			'Client Categories Widget', // Name
			array( 'description' => __( 'List the Client Categories', 'benefactor' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$terms = get_terms( 'client_categories' );
...
add_action( 'widgets_init', 'client_cat' );

function client_cat() {
	register_widget( 'Benefactor_Client_Cat_Widget' );
}
?>