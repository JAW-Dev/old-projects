...
*/
get_header();
$kl_contact_page_title = ( get_field( 'kl_contact_page_title' ) ? get_field( 'kl_contact_page_title' ) : '' );
?>
<main id="main" itemprop="mainContentOfPage" role="main">
    <div class="body__content contact">
        <h1 class="contact_title"><?php echo $kl_contact_page_title;?></h1>
	</div>
	<?php get_template_part( 'template-parts/content/contact/contactfull' ); ?>
<?php
...
?>
<div class="body__content pages-mobile contact">
	<div class="content__row">
		<div class="section__heading first">
