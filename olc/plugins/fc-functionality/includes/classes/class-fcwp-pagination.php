...
if( !class_exists( 'FCWP_Pagination' ) ) {
	class FCWP_Pagination {
		...
		private function display() {
			...
			$sr_text                 = ( !empty( $this->args['sr_text'] ) ? __( $this->args['sr_text'], FCWP_PL_TEXTDOMAIN) : "" );
			...
			$sep                     = ( !empty( $this->args['sep'] ) ? __( $this->args['sep'], FCWP_PL_TEXTDOMAIN) : "" );
			$prelabel                = ( !empty( $this->args['prelabel'] ) ? __( $this->args['prelabel'], FCWP_PL_TEXTDOMAIN) : "" );
			$nextlabel               = ( !empty( $this->args['nextlabel'] ) ? __( $this->args['nextlabel'], FCWP_PL_TEXTDOMAIN) : "" );
...
if( ! function_exists( 'fcwp_pagination') ) {
  function fcwp_pagination( $type, $args = array() ) {
  	$fcwp_pagination = new FCWP_Pagination( $type, $args );
  }
} // end fcwp_pagination